...
module.exports = class PackageWatcher extends Watcher {
  ...
  // Every stylesheet takes the same path, a theme's variables.css included:
  // custom properties cascade at runtime, so re-attaching the package that
  // defines them restyles everything that reads them.
  loadStylesheet() {
    this.queueReload();
  }
