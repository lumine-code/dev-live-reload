module.exports = {
  ...
  startWatching() {
    ...
    this.commandDisposable = lumine.commands.add("lumine-workspace", "dev-live-reload:reload-all", {
      description: "Reload every stylesheet and package in this window.",
      didDispatch: () => this.uiWatcher.reloadAll(),
    });
    if (this.activatedDisposable) this.activatedDisposable.dispose();
  },
};
